...
- **LevenbergMarquardtOptimizerG2o**: A custom optimizer that wraps GTSAM's Levenberg-Marquardt optimization to handle **Similarity3** transformations. This is useful for optimizing large SLAM graphs.
